...
import { CustomButton, CustomButtonText, Linha, EntreEspacos, LinhaCentral, EntreEspacosGrande } from './styles';
...
export default () => {
    ...
    const [dataNascimentoField, setDataNascimentoField] = useState(userInfo.dataNascimento);
    ...
    const handleChangeClick = async () => {
        ...
        const handleExperiencia = () => {
            navigation.navigate('ProfileUpdateExpFor', {
                nome: userInfo.nome,
